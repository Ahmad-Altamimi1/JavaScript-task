...
function usAndNumberBeetweenUs(num1=2,num2=7) {
 let arr = [num1,num2]
 arr.length=num2-num1 -1
 let arr2 = arr.map(function (ele,index,arr) {
  if (index==arr.length) {
    arr=(arr).splice(index,3)
    console.log(arr);
...
console.log(usAndNumberBeetweenUs())
// console.log(usAndNumberBeetweenUs(2,7))
// console.log(1<1);
// console.log(usAndNumberBeetweenUs())
...
*/
// reduceee=[]
 let persons1=persons.reduce(function (acc,cu) {
...
let longestName1=persons.reduce(function (acc,cu) {
  let fullname=cu.name.first +cu.name.last
if (fullname.length>acc.length){
